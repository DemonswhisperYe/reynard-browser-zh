...
final class SearchViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    private lazy var userDataHeaderView = makeSectionHeaderView(title: L("Bookmarks, History, and Tabs"))
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        case .typedQuery:
            return hasQuery ? makeSectionHeaderView(title: String(format: L("%@ Suggestions"), viewModel.searchSuggestionProvider.name)) : nil
        case .completions:
            return nil
        case .userDataResults:
