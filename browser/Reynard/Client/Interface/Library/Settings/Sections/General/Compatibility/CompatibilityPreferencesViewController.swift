...
final class CompatibilityPreferencesViewController: SettingsTableViewController {
    ...
    override func sectionText(for section: Int) -> SettingsSectionText {
        ...
        return SettingsSectionText(
            ...
            footerTitle: L("If you encounter issues such as sign-in failures, human verification challenges, or other incorrect site behavior, adding the site's URL to this user agent override list may help resolve the problem.")
        )
    }
